...
class Location_Tracker:
    def __init__(self, App):
        ...
        Label(App, text="Enter a Phone Number",fg="white", font=("Times", 20), bg="green").place(x=150,y= 30)
        self.phone_number = Entry(App, width=16, font=("Arial", 15), relief="flat")
        self.track_button = Button(App,fg="white", text="Track Country", bg="green", relief="sunken")
        self.country_label = Label(App,fg="white", font=("Times", 20), bg="green")
